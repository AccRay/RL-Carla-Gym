...
from gym_carla.single_lane_env.carla_agent.local_planner import LocalPlanner
from gym_carla.single_lane_env.carla_agent.global_route_planner import GlobalRoutePlanner
from gym_carla.single_lane_env.tools.misc import get_speed, is_within_distance, get_trafficlight_trigger_location, compute_distance
...
class BasicAgent(object):
    ...
    def run_step(self):
        ...
        if hazard_detected:
            # this parameter need to be monitored（control）
